...
if __name__ == "__main__":
    url = "https://ya.ru/" #- обнаруженно 0 форм - Уязвимости нет
    # url = "https://habr.com/ru/articles/" - обнаруженно 0 форм - уязвимости нет
    # Я чекнул пару сайтов с уязвимостями, на всех сработал, но все сайты с уязвимостями развёртывались временно, поэтому не вставил код сюда
